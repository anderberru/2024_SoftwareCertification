	...
	[' FranchiseConnect', '../main/home_page.htm',
		...
		[' Memoriaren eranskinak',null,
			[' A1 - Sarrerako Dokumentazioa',null,
				...
				['Bezeroari buruzko informazioa','../Proiektua/MemoriarenEranskinak/Empresaren informazioa.pdf'],
			...
			[' A5 - Proposamenaren segurtasun plana',null,
 			...
 			[' A6 - Gainerako Eranskinak', null,
				[' Hedapena', null,
					...
					['ikuskaritza(5 taldeak guri egindakoa)', '../Proiektua/MemoriarenEranskinak/ikuskaritza(5 taldeak guri egindakoa).pdf']
				],
				[' Garapena', null,
				...
				[' Inplementazioa (inplementation', null, 
					[' Inplementazio osoaren iturburuak', '../Proiektua/MemoriarenEranskinak/_Bertsio desberdinen iturburuak.pdf'],

				],
				[' Prototipo eta produktu exekutagarriak (build)', null, 
					[' Prototipoak', '../Proiektua/MemoriarenEranskinak/Prototipoak eta produktu exekutagarriak.pdf'],
					[' Produktuak ', '../Proiektua/MemoriarenEranskinak/Prototipoak eta produktu exekutagarriak.pdf'],
				],
				[' Test' , null,
					...
					[' User acceptace test (UAT)','../Proiektua/MemoriarenEranskinak/User-Accetptance-Test-Plan-Free-Word.pdf'],
					[' Proposamena RFPekin parekatuta ebaluatzeko txantiloia', '../Proiektua/MemoriarenEranskinak/Proposamena RFPekin parekatuta ebaluatzeko txantiloia.pdf'],
		...
		[' Sistemaren Espezifikazioa',null,
			...
			[' Erabilpen kasuak (jarduera diagramekin)', null,
				[' Soporte y Atencion al Cliente','../Proiektua/SistemarenEspezifikazioa/usecase_specification_Soporte y Atencion al Cliente.pdf'],
				[' Soporte y Atencion al Cliente (UML)','../Proiektua/SistemarenEspezifikazioa/UML/RSAD/images/_Y.tI78.s9.cE.e68.d.qX.b.rJDC.k.g.PNG'],
				[' Integracion con Sistemas Existentes','../Proiektua/SistemarenEspezifikazioa/usecase_specification_Integracion con Sistemas Existentes.pdf'],
				//[' Integracion con Sistemas Existentes (UML)','../Proiektua/SistemarenEspezifikazioa/glossary.pdf'],
				[' Formacion para Franquiciados','../Proiektua/SistemarenEspezifikazioa/usecase_specification_Formacion para Franquiciados.pdf'],
				[' Formacion para Franquiciados (UML)', '../Proiektua/SistemarenEspezifikazioa/UML/RSAD/images/_YAJTE.s9.cE.e68.d.qX.b.rJDC.k.g.PNG'],
				[' Gestion de operaciones','../Proiektua/SistemarenEspezifikazioa/usecase_specification_Gestion de operaciones.pdf'],
				//[' Gestion de operaciones (UML)','../Proiektua/SistemarenEspezifikazioa/glossary.pdf'],
